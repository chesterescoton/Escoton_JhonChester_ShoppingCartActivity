...
# Day 3 
On Day 3, I finished the rest of the program. I added the part where the selected items are added to the cart and the stock gets reduced. I also made sure that if the same product is chosen again, it just updates the quantity instead of adding a duplicate. After that, I created the receipt part where all the items, quantities, and totals are displayed. I computed the grand total and added a 10% discount if the total is 5000 or more. Finally, I showed the final total and the updated stock after checkout. This completes the program by showing the results of the user’s purchases.
